...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	globalModelPricingService := service.NewGlobalModelPricingService(globalModelPricingRepository, billingService)
	modelPricingResolver := service.NewModelPricingResolverWithGlobalOverrides(channelService, billingService, globalModelPricingRepository)

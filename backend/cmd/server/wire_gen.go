...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	connectedAccountService := service.NewConnectedAccountService(accountRepository, groupRepository, openAIOAuthService, oAuthService, geminiOAuthService)
	...
	stripeBillingService := service.NewStripeBillingService(paymentService, paymentConfigService, userRepository, userSubscriptionRepository, billingCacheService)
	...
	handlerPaymentHandler := handler.NewPaymentHandler(paymentService, paymentConfigService, channelService, stripeBillingService)
	paymentWebhookHandler := handler.NewPaymentWebhookHandler(paymentService, registry, stripeBillingService)

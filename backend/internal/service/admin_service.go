...
type AdminService interface {
	...
	RefreshAccountModels(ctx context.Context, id int64) ([]claude.Model, error)
...
func (s *adminServiceImpl) RefreshAccountModels(ctx context.Context, id int64) ([]claude.Model, error) {

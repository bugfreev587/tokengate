...
type UsageLog struct {
	...
	// Capacity source used for billing semantics: tokengate or connected_account.
...
func (*UsageLog) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case usagelog.FieldRequestID, usagelog.FieldModel, usagelog.FieldRequestedModel, usagelog.FieldUpstreamModel, usagelog.FieldModelMappingChain, usagelog.FieldBillingTier, usagelog.FieldBillingMode, usagelog.FieldCapacitySource, usagelog.FieldUserAgent, usagelog.FieldIPAddress, usagelog.FieldImageSize:
...
func (_m *UsageLog) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case usagelog.FieldCapacitySource:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field capacity_source", values[i])
			} else if value.Valid {
				_m.CapacitySource = value.String
			}
...
func (_m *UsageLog) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("capacity_source=")
	builder.WriteString(_m.CapacitySource)
	builder.WriteString(", ")

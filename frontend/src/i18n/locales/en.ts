export default {
  ...
  keys: {
    ...
    connectionTestSuccess: 'Connection OK',
    connectionTestFailed: 'Connection failed',
    connectionTestRequestFailed: 'Failed to test connection',
    connectionModelsVisible: 'Models visible',
    connectionModelsTested: 'Models tested',
    connectionModelsSkipped: 'Skipped',
    connectionTruncated: 'Showing the first tested models only.',
    connectionModel: 'Model',
    connectionLatency: 'Latency',
    connectionEndpoint: 'Endpoint',
    connectionMessage: 'Message',
    connectionNoResults: 'No model probe results were returned.',
    connectionStatus: {
      success: 'OK',
      error: 'Failed',
      skipped: 'Skipped',
    ...
    createFirstKey: 'Create your first API key, then send a quick test request to see usage and balance updates.',
  ...
  usage: {
    ...
    noRecordsTitle: 'No usage yet',
    noRecordsDescription: 'Send your first model request with a TokenGate API key. Successful requests will appear here with model, token, cost, and latency details.',
    createOrUseKey: 'Create or use a key',
    viewQuickstart: 'View quickstart',
  ...
  admin: {
    ...
    users: {
      ...
      makeAdminConfirm: "Promote '{email}' to admin? They will be able to access all admin pages and settings.",
      makeAdminSuccess: 'User promoted to admin successfully',
      failedToMakeAdmin: 'Failed to promote user to admin',
      testUserBadge: 'Test',
      setTestUser: 'Set Test User',
      unsetTestUser: 'Unset Test User',
      setTestUserConfirm: "Mark '{email}' as a test user? Stripe payments for this user will use the sandbox account.",
      unsetTestUserConfirm: "Remove test-user mode from '{email}'? Stripe payments for this user will use the live account.",
      setTestUserSuccess: 'User marked as test user',
      unsetTestUserSuccess: 'User is no longer a test user',
      failedToSetTestUser: 'Failed to update test-user setting',
    ...
    accounts: {
      ...
      testAllModelsConnection: 'Test all models connection',
      testingAllModels: 'Testing all available models ({count})...',
      testingModel: 'Testing model: {model}',
      testAllModelsModelPassed: '{model} passed',
      testAllModelsModelFailed: '{model} failed: {error}',
      testAllModelsSummary: 'All model tests finished: {passed}/{total} passed',
      testAllModelsFailedSummary: 'All model tests finished: {passed}/{total} passed, {failed} failed',
      noModelsAvailableForTest: 'No models available to test',
    ...
    settings: {
      ...
      payment: {
        ...
        dailyLimit: 'Daily Limit',
	        ...
	        usdCnyRateHint: 'Admin configured exchange rate for CNY payments. TokenGate prices and balances stay in USD.',
	        usdCnyRatePreview: 'Preview: 1 USD = {rate} CNY',
  ...
  purchase: {
    ...
    description: 'Choose Usage Based balance recharge or BYO subscription mode',
  ...
  userAccounts: {
    ...
    chooseProviderTitle: 'Choose an account provider',
    chooseProviderDescription: 'Pick which provider you want to authorize for this private group.',
    connectProviderTitle: 'Connect a {provider} account',
    ...
    emptyDescription: 'Connect your own AI account to create a private group only your API keys can use.',
    ...
    providers: {
      ...
      geminiDescription: 'Use a Gemini account as a private upstream.'
    },
    columns: {
      name: 'Name',
      platform: 'Platform',
  ...
  payment: {
    ...
    summary: {
      ...
      byoLabel: 'BYO subscription',
      byoValue: 'Own account',
      byoHint: 'TokenGate routes requests through your connected provider account after subscription.',
      byoStepOneTitle: 'Bind account',
      byoStepOneDesc: 'Connect your own supported AI provider account.',
      byoStepTwoTitle: 'Subscribe access',
      byoStepTwoDesc: 'Keep the BYO route available to your API keys.',
      byoStepThreeTitle: 'Use own quota',
      byoStepThreeDesc: 'Requests consume tokens or quota from your provider account.',
    },
    modeTabs: {
      usageBased: {
        label: 'Usage Based mode',
        description: 'Recharge and pay per token',
      },
      byoSubscription: {
        label: 'BYO subscription mode',
        description: 'Subscribe, then use your account',
      },
    },
    modeDescriptions: {
      usageBased: {
        title: 'Usage Based mode uses your TokenGate balance',
        desc: 'Recharge first, then each request deducts balance according to model pricing and actual token, image, or video usage.',
      },
      byoSubscription: {
        title: 'BYO subscription mode uses your own AI account',
        desc: 'Bind your provider account, subscribe to unlock access, and requests consume the tokens or quota on your own account.',
      },
    },
	    amountLabel: 'Amount',
    ...
    fee: 'Fee',
	    ...
	    usdCnyRatePreview: 'Paying in CNY uses the admin configured rate: 1 USD = {rate} CNY',
    ...
    balanceExplainer: {
      ...
      desc: 'Use balance for metered requests. Text models are charged by token usage, while image and video models use their native units.',
    },
    ...
    planExplainer: {
      title: 'Subscribe to use your connected account through TokenGate',
      stepOneTitle: 'Bind your account',
      stepOneDesc: 'Connect a supported AI provider account before using BYO groups.',
      stepTwoTitle: 'Keep access active',
      stepTwoDesc: 'The subscription keeps this BYO route available to your API keys.',
      stepThreeTitle: 'Use own quota',
      stepThreeDesc: 'Requests are served by your provider account instead of charging TokenGate balance.',
    },
    ...
    admin: {
      ...
      billingProviderInternal: 'Internal',
      billingProviderStripe: 'Stripe',
      billingModeFixedPeriod: 'Fixed Period',
      billingModeSubscription: 'Subscription',
      stripeLivePriceId: 'Live Price ID',
      stripeSandboxPriceId: 'Sandbox Price ID',
      stripeTrialDays: 'Trial Days',
      forSale: 'For Sale',
      onSale: 'On Sale',
      offSale: 'Off Sale',
      group: 'Group',

/**
 * Vue Router configuration for TokenGate frontend
...
const BACKEND_MODE_ALLOWED_PATHS = ['/login', '/forgot-password', '/reset-password', '/key-usage', '/docs', '/pricing', '/support', '/setup', '/payment/result', '/payment/airwallex', '/legal']
...
router.beforeEach((to, _from, next) => {
  ...
  if (to.name === 'CustomPage') {
    ...
    if (menuItem?.label) {
      const siteName = appStore.siteName || 'TokenGate'
